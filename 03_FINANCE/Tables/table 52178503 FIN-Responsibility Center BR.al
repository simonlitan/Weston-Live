table 52178503 "FIN-Responsibility Center BR"
{
    Caption = 'Responsibility Center';
    //DrillDownPageID = "FIN-Resp. Center List BR";
    //LookupPageID = "FIN-Resp. Center List BR";
    ...
    var
        ItemLedgEntry: Record "FIN-Payments Header";
    begin
