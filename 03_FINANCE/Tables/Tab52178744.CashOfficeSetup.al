table 52178744 "Cash Office Setup"
{
    ...
    fields
    {
        ...
        field(50051; "Advance Petty Cash"; code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(50052; "Surrender Petty Cash"; code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(500005; "Casual Req. No's"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(667488; "Casual Employee Nos."; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(50053; "Casual Expense AC"; Code[30])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(50054; "Casual Liability AC"; Code[30])
        {
            TableRelation = "G/L Account"."No.";
        }
