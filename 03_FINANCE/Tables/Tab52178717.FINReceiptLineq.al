...
{
    LookupPageID = "FIN-Receipts Line UP";
    DrillDownPageId = "FIN-Receipts Line UP";
    ...
    fields
    {
        ...
        field(3; Type; Code[20])
        {
            ...
            begin
                ...
                END;
                RHead.Reset();
                RHead.SetRange("No.", No);
                if RHead.Find('-') then begin
                    RHead."Received From Account Type" := RecPayTypes."Type";
                end;
        ...
        field(20; Amount; Decimal)
        {
            ...
            trigger OnValidate()
            var
                recptLine: Record "FIN-Receipt Line q";
                amt: Decimal;
            begin
                ...
                if Amount > 0 then begin
                    ...
                    if ReceiptHeader.Find('-') then begin
                        ...
                        // ReceiptHeader."Amount Recieved" := ReceiptHeader."Total Amount";
                        // ReceiptHeader.Modify();

                        /* if recptLine.find('-') then begin
                            repeat
                                amt := amt + recptLine.Amount;
                            until recptLine.Next() = 0;
                            ReceiptHeader."Amount Recieved" := amt + Amount;
                            ReceiptHeader."Total Amount" := amt + Amount;
                            ReceiptHeader.Modify();
                        end; */
                    end;
                end;
        ...
        field(86; "Applies-to Doc. No."; Code[20])
        {
            ...
            begin
                ...
                IF CustLedgEntry.FIND('-') THEN BEGIN
                    ...
                    //"Apply to" := CustLedgEntry."Document No.";
                    VALIDATE(Amount);
                END;
            end;
    ...
    var
        ...
        ApplyCustEntries: Page "Apply Customer Entries3";
