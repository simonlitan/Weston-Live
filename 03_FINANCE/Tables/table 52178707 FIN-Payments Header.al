/// <summary>
/// Table FIN-Payments Header (ID 52178707).
/// </summary>
table 52178707 "FIN-Payments Header"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Cheque/EFT No./PDQ';

        }
        field(67; "Pay Mode"; Option)
        {
            OptionMembers = " ",Cash,Cheque,EFT,PDQ,"Letter of Credit","Custom 3","Custom 4","Custom 5";
        ...
        field(12; "Creation Doc No."; Text[20])
        {
        ...
        field(14; "External Doc No"; Code[20])
        {

        }
        field(15; BoardPay; Integer)
        {

        }
        field(21; CommitteePay; Integer)
        {
        ...
        field(23; IsBoardPV; Integer)
        {

        }
        field(24; IsCommitteePV; Integer)
        {
        ...
        field(26; "Meeting Code"; Code[20])
        {

        }
        field(27; "Meeting Name"; Code[20])
        {

        }
        field(29; "Task Order No"; Code[20])
        {

        }
        field(31; "Transaction Number"; Code[20])
        {

        }
        field(32; "Reference Number"; Code[20])
        {
            ObsoleteState = Removed;


        }
        // field(34; "Reffrence Numbe"; Text[30])
        // {
        //     ObsoleteState = Removed;
        //     ObsoleteReason = 'Deprecated';

        // }
        field(36; "Reffrence Number"; Text[30])
        {
            ObsoleteState = Removed;
            ObsoleteReason = 'Deprecated';
        }
        field(33; "Advise Sent"; Integer)
        {
        ...
        field(50163; "Invoice No"; Code[70])
        {

        }
        field(50164; "Order No"; Code[70])
        {

        }
        field(50165; "PIN  NO"; Code[30])
        {
