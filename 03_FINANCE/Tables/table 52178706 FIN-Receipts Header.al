table 52178706 "FIN-Receipts Header"
{
    ...
    fields
    {
        ...
        {
            TableRelation = "FIN-Receipt Line q".Amount;
            CalcFormula = Sum("FIN-Receipt Line q".Amount WHERE(No = FIELD("No.")));
            Editable = false;
...
#pragma warning restore AL0717
        ...
        {
            OptionCaption = ' ,Cash,Cheque,Mpesa,EFT,PDQ,Deposit Slip,Banker''s Cheque,RTGS';
            OptionMembers = " ",Cash,Cheque,Mpesa,EFT,PDQ,"Deposit Slip","Banker's Cheque",RTGS;
