report 52178539 "Projection Report"

{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/Projection Report.rdl';
        ...
        dataitem(Header; "Integer")
        {
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
                {
                    ...
                    begin
                        SetRange("Posting Date", EndingDate + 1, DMY2Date(30, 12, 9999));
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempCustLedgEntryLoop; "Integer")
                    {
                        ...
                        column(Projection; CustLedgEntryEndingDate."Remaining Amount" -TotalCustLedgEntry[2]."Remaining Amount")
                        {
            ...
            dataitem(CurrencyTotals; "Integer")
            {
                ...
                begin
                    ...
                    if TempCurrencyAmount.FindSet(false, false) then
                        repeat
                            if TempCurrencyAmount.Date <> DMY2Date(30, 12, 9999) then
    ...
    begin
        ...
        if AgingBy = AgingBy::"Due Date" then begin
            PeriodEndDate[1] := DMY2Date(30, 12, 9999);
