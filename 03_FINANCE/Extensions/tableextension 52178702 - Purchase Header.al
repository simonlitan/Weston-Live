tableextension 52178702 "Purchase Header" extends "Purchase Header"
{
    fields
    {
        ...
        field(52178501; "Shortcut Dimension 1"; code[10])
        {
            DataClassification = ToBeClassified;
            ...
            begin
                dim.Reset();
                dim.SetRange("Dimension Code", "Shortcut Dimension 1");
                if dim.FindFirst() then
                    "Departments Name" := dim.Name;


            end;

        }
        field(52178502; "Departments Name"; text[100])
        {

            DataClassification = ToBeClassified;
        }
        field(52178505; "User Id"; code[50])
        {

        }
        field(52178503; "Assigned User ID 2"; code[50])
        {
            DataClassification = ToBeClassified;
        ...
        field(52178506; "Total Line Discount"; Decimal)
        {
            FieldClass = FlowField;
