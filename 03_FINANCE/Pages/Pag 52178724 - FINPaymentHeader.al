page 52178724 "FIN-Payment Header"
{
    ...
    DeleteAllowed = false;
    PageType = Card;
    PromotedActionCategories = 'New,Process,Reports,Approvals,Budgetary Control,Posting,Category7_caption,Attachments,Category9_caption,Category10_caption';
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Applied LPO"; Rec."Applied LPO")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Applied LPO field.';
                }
                field("Archived LPO"; Rec."Archived LPO")
                {
                    Editable = false;
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Archived LPO field.';
                }
    ...
    begin
        ...
        IF PayLine.FIND('-') THEN BEGIN
            ...
            REPEAT
                ...
                // GenJnlLine.VALIDATE(GenJnlLine."Account No.");
                GenJnlLine."External Document No." := Payments."Cheque No.";
                GenJnlLine.Description := COPYSTR(PayLine."Account Name" + ':' + Payment.Payee, 1, 100);
                GenJnlLine."Currency Code" := Payments."Currency Code";
                ...
                IF TarriffCodes.FIND('-') THEN BEGIN
                    ...
                    GenJnlLine."Bal. Account No." := '';
                    GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                    GenJnlLine.Description := COPYSTR('VAT Withheld:' + FORMAT(PayLine."Account Name") + '::' + strText, 1, 100);
                    GenJnlLine."Shortcut Dimension 1 Code" := PayLine."Global Dimension 1 Code";
                    //GenJnlLine."Shortcut Dimension 2 Code" := Rec."Shortcut Dimension 2 Code";
                    //GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 2 Code");
                    GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 1 Code");
                ...
                IF TarriffCodes.FIND('-') THEN BEGIN
                    ...
                    GenJnlLine."Bal. Account No." := '';
                    GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                    GenJnlLine.Description := COPYSTR('W/Tax:' + FORMAT(PayLine."Account Name") + '::' + strText, 1, 100);
                    GenJnlLine."Shortcut Dimension 1 Code" := PayLine."Global Dimension 1 Code";
                    // GenJnlLine."Shortcut Dimension 2 Code" := Rec."Shortcut Dimension 2 Code";
                    // GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 2 Code");
                    GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 1 Code");
                ...
                IF PayLine."Retention  Amount" <> 0 THEN BEGIN
                    ...
                    IF TarriffCodes.FIND('-') THEN BEGIN
                        ...
                        GenJnlLine."Bal. Account No." := '';
                        GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                        GenJnlLine.Description := COPYSTR('Retension ' + FORMAT(PayLine."Account Name") + '::' + strText, 1, 100);
                        GenJnlLine."Shortcut Dimension 1 Code" := PayLine."Global Dimension 1 Code";
                        // GenJnlLine."Shortcut Dimension 2 Code" := Rec."Shortcut Dimension 2 Code";
                        // GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 2 Code");
                        GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 1 Code");
                        ...
                        GenJnlLine."Bal. Account Type" := GenJnlLine."Bal. Account Type"::"G/L Account";
                        GenJnlLine."Bal. Account No." := '';
                        GenJnlLine.Description := COPYSTR('Retension Balancing-' + Payments.Payee, 1, 100);
                        GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                        GenJnlLine."Shortcut Dimension 1 Code" := PayLine."Global Dimension 1 Code";
                        GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 1 Code");
                        // GenJnlLine."Shortcut Dimension 2 Code" := Rec."Shortcut Dimension 2 Code";
                ...
                IF PayLine."PAYE Amount" <> 0 THEN BEGIN
                    ...
                    IF TarriffCodes.FIND('-') THEN BEGIN
                        ...
                        GenJnlLine."Bal. Account Type" := GenJnlLine."Bal. Account Type"::"G/L Account";
                        GenJnlLine."Bal. Account No." := '';
                        GenJnlLine.Description := COPYSTR('PAYE Balancing-' + Payments.Payee, 1, 100);
                        GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                        GenJnlLine."Shortcut Dimension 1 Code" := PayLine."Global Dimension 1 Code";
                        GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 1 Code");
                        // GenJnlLine."Shortcut Dimension 2 Code" := Rec."Shortcut Dimension 2 Code";
                ...
                GenJnlLine."Bal. Account Type" := GenJnlLine."Bal. Account Type"::"G/L Account";
                GenJnlLine."Bal. Account No." := '';
                GenJnlLine.Description := COPYSTR(Payments.Payee, 1, 100);
                GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                GenJnlLine."Shortcut Dimension 1 Code" := PayLine."Global Dimension 1 Code";
                GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 1 Code");
                // GenJnlLine."Shortcut Dimension 2 Code" := Rec."Shortcut Dimension 2 Code";
                ...
                GenJnlLine."Bal. Account Type" := GenJnlLine."Bal. Account Type"::"G/L Account";
                GenJnlLine."Bal. Account No." := '';
                GenJnlLine.Description := COPYSTR('W/Tax Balancing-' + Payments.Payee, 1, 100);
                GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                GenJnlLine."Shortcut Dimension 1 Code" := PayLine."Global Dimension 1 Code";
                GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 1 Code");
                // GenJnlLine."Shortcut Dimension 2 Code" := Rec."Shortcut Dimension 2 Code";
                ...
                GenJnlLine.Description := COPYSTR('Repay advance to: ' + Payments.Payee, 1, 100);
                GenJnlLine.VALIDATE(GenJnlLine.Description);
    ...
    begin
        ...
        BCSetup.GET;
        IF NOT (BCSetup."PV Budget Mandatory") THEN EXIT;
        ...
        IF FINPaymentLine.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF checkBudgetControl(GLAccount."No.") = FALSE THEN EXIT;
                ...
                IF FINBudgetEntries.FIND('-') THEN BEGIN
                    IF FINBudgetEntries.CALCSUMS(Amount) THEN BEGIN
                        IF FINBudgetEntries.Amount > 0 THEN BEGIN
                            ...
                            PostBudgetEnties.CheckBudgetAvailability(FINPaymentLine."Account No.", Rec.Date, Rec."Global Dimension 1 Code", Rec."Shortcut Dimension 2 Code", FINPaymentLine.Amount, FINPaymentLine."Account Name", 'PV', Rec."No." + FINPaymentLine."Account No.", Rec.Payee);
                        END ELSE
        ...
        IF FINPaymentLine.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINPaymentLine.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.ExpenseBudgetGlobal(FINPaymentLine."Account No.", Rec.Date, FINPaymentLine.Amount, FINPaymentLine."Account Name", USERID, TODAY, 'PV', Rec."No." + FINPaymentLine."Account No.", Rec.Payee);
                END;
            END;
            UNTIL FINPaymentLine.NEXT = 0;
        END;
    ...
    begin
        ...
        IF FINPaymentLine.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINPaymentLine.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.CancelBudgetCommitmentGlobal(FINPaymentLine."Account No.", Rec.Date,
