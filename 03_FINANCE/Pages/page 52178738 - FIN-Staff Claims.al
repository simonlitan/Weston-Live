            ...
            BEGIN
                ...
                IF FINBudgetEntries.FIND('-') THEN BEGIN
                    ...
                    IF FINBudgetEntries.Amount > 0 THEN BEGIN
                        ...
                        THEN
                            ERROR('Less Funds, Account:' + GLAccount.Name + ', Cost_Center:' + DimensionValue.Name);
                    ...
                    END
                    ELSE
                        ERROR('No allocation for  Account:' + GLAccount.Name + ', Branch:' + Rec."Shortcut Dimension 2 Code");
                    // END;
                END ELSE
                    ERROR('Missing Budget for  Account:' + GLAccount.Name + ', Branch:' + Rec."Shortcut Dimension 2 Code");
            END;
