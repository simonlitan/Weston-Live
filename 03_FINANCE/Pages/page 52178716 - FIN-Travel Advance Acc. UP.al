        ...
        area(processing)
        {
            action(Approve)
            {
                ...
                begin
                    ...
                    if rec."Actual Spent" + rec."Cash Surrender Amt" <> rec.Amount then Error('Amount to be accounted is not equal to advanced amount');
            ...
            action(sendApproval)
            {
                ...
                begin
                    ...
                    if rec."Actual Spent" <> rec.Amount then Error('Amount to be accounted is not equal to amount given');
                    if rec."Actual Spent" > rec.Amount then Error('Actual Spent cannot be greater then the amount given');
        ...
        IF FINImprestSurrLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                IF (FINImprestSurrLines.Amount > 0) THEN BEGIN
                    // Commit Budget Here
                    PostBudgetEnties.ExpenseBudgetGlobal(FINImprestSurrLines."Account No:", Rec."Surrender Date",
