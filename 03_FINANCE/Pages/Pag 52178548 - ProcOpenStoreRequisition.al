page 52178548 "Proc-Open Store Requisition"
{
    ...
    ApplicationArea = all;
    PromotedActionCategories = 'New, Process, Report,Approval,Posting';
...
;
                ...
                {
                    ApplicationArea = all;
                    Caption = 'Print/Preview Consuption';
                    Image = PreviewChecks;
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = report "Items Consuption";


                }
                action("Print/Previe9w1")
                {
                    ApplicationArea = all;
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    RunObject = report "Phys. Inventory List1";


                }
                action(Dimensioncorrection)
                {
                    ApplicationArea = all;
                    RunObject = page "Dimensions correction Page";
                }
                separator(sep004)
                {
                }
