page 52178789 "Proc-Purchase Quote"
{
    ...
    PageType = Document;
    PromotedActionCategories = 'New,Process,Report,Approve,Request Approval, Bid analysis';
    ...
    layout
    {
        ...
        area(factboxes)
        {
            part(Factbox; "Pending Approval FactBox")
            {
            ...
            part("Buy from Vendor"; "Vendor Details FactBox")
            {
                SubPageLink = "No." = FIELD("Buy-from Vendor No.");
                Visible = false;
                ApplicationArea = All;
            }
            part("Pay to Vendor No"; "Vendor Statistics FactBox")
            {
                SubPageLink = "No." = FIELD("Pay-to Vendor No.");
                ApplicationArea = All;
            }
            part("Buy from Vendor No"; "Vendor Hist. Buy-from FactBox")
            {
                SubPageLink = "No." = FIELD("Buy-from Vendor No.");
                ApplicationArea = All;
            }
            part("Pay to Vendor"; "Vendor Hist. Pay-to FactBox")
            {
                SubPageLink = "No." = FIELD("Pay-to Vendor No.");
                Visible = false;
                ApplicationArea = All;
            }
            part("Purchase Line"; "Purchase Line FactBox")
            {
                Provider = PurchLines;
            ...
            part("Table Id"; "Approval FactBox")
            {
                SubPageLink = "Table ID" = CONST(38),
                              "Document Type" = FIELD("Document Type"),
                              "Document No." = FIELD("No.");
