    ...
    begin
        ...
        IF PROCStoreRequistionLines.FIND('-') THEN BEGIN
            ...
            BEGIN
                ...
                //FINBudgetEntries.SETFILTER(Date, PostBudgetEnties.GetBudgetStartAndEndDates(Rec."Issue date"));
                IF FINBudgetEntries.FIND('-') THEN BEGIN
                    IF FINBudgetEntries.CALCSUMS(Amount) THEN BEGIN
                        IF FINBudgetEntries.Amount > 0 THEN BEGIN
                           ...
                           // PostBudgetEnties.CheckBudgetAvailability(Item."Item G/L Budget Account", Rec."Issue Date", '', Rec."Shortcut Dimension 2 Code",
