report 52178521 "New Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/NewReportP.rdl';
    ...
    /*    local procedure MakeExcelDataHeader()
       ...
       begin
           ...
           //     ExcelBuf.AddColumn(objEmp."PIN Number", FALSE, '', FALSE, FALSE, TRUE, '', 0);
           //     ExcelBuf.AddColumn(objEmp."First Name" + ' ' + objEmp."Middle Name" + ' ' + objEmp."Last Name", FALSE, '', FALSE, FALSE, TRUE, '', 1);

           //     ExcelBuf.AddColumn(objEmp."Residential Address", FALSE, '', FALSE, FALSE, FALSE, '', 0);
    ...
    // ExcelBuf.CreateBook('iTax', 'Pritax');
    //ExcelBuf.CreateBookAndOpenExcel('', 'iTax');
    //  ExcelBuf.CreateBookAndOpenExcel('Itax', 'Itax', 'iTax', 'Weston', UserId);
    ...
    // ExcelBuf.CreateBook('iTax', 'Itax');
    // ExcelBuf.CreateBookAndOpenExcel('Sheet1', 'Sheet1', 'iTax', 'Weston', UserId);
