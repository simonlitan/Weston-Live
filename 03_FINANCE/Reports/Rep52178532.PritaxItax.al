report 52178532 PritaxItax
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/ItaxPritax.rdl';
    ...
    dataset
    {
        dataitem("prPeriod Transactions_"; "PRL-Period Transactions")
        {
            ...
            begin
                ...
                transCode.RESET;
                //transCode.SETRANGE("Transaction Code"."itax Grouping",transCode."itax Grouping"::"House Allowance");
    ...
    var
        ...
        dt1: Date;
        dt2: Date;
        objholidays: Record "HRM-Holidays";
    ...
    //     ExcelBuf.CreateBook('iTax', 'pretaxt');
