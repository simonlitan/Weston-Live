report 52178731 "Procurement Report"
{
    ...
    dataset
    {
        dataitem(PurchaseHeader; "Purchase Header")
        {
            ...
            column(vatAmout; "Amount Including VAT" - Amount)
            {
            ...
            column(signature1; UserSetup1."User Signature")
            {

            }
            column(signature2; UserSetup2."User Signature")
            {

            }
            column(signature3; UserSetup3."User Signature")
            {
            ...
            dataitem(Vendor; Vendor)
            {
                ...
                column(ttDisc; ttDisc)
                {

                }
                column(ttExlVat; ttExlVat)
                {

                }
                column(ttInCVat; ttInCVat)
                {
            ...
            dataitem(PurchaseLine; "Purchase Line")
            {
                ...
                begin
                    // pheader.Reset();
                    // pheader.SetRange("No.", PurchaseLine."Document No.");
            ...
            begin
                CalcFields("Total Line Discount", Amount, "Amount Including VAT");
                if "Invoice Discount Amount" = 0 then
                    TotalDiscount := "Total Line Discount"
                else
