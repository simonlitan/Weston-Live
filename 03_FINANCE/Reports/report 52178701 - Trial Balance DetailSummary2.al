report 52178701 "Trial Balance Detail/Summary2"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(DataItem6710; "G/L Account")
        {
            ...
            column(CompanyInfoPhone1; CompanyInformation."Phone No.")
            {
            }
            column(CompanyInfoPhone2; CompanyInformation."Contact Person")
            {
            }
            column(CompanyInfoAdress; CompanyInformation.Address)
            {
            }
            column(CompanyInfoPostal; CompanyInformation."Post Code")
            {
            }
            column(CompanyInfoEmail; CompanyInformation."E-Mail")
            {
            }
            column(CompanyInfoWebpage; CompanyInformation."Home Page")
            {
            }
            ...
            dataitem(DataItem7069; "G/L Entry")
            {
                ...
                begin
                    IF PrintDetail or IncludeSecondLine THEN BEGIN
                        SourceName := '';
                        CASE "Source Type" OF
