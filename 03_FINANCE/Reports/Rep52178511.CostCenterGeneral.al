report 52178512 "Cost Center General2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/CostCenterGeneral.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = WHERE("Item Status" = FILTER(posted), "Quantity Issued" = filter(>=1));
            ...
            begin
                "Store Requistion Lines".CALCFIELDS("Store Requistion Lines"."Product Group", "Posting Date");
