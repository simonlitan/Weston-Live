// report 52178529 "Bank Acc. Recon. - Manual1"
...
//     dataset
//     {
//         dataitem(BankAccRecon; "Bank Acc. Reconciliation")
//         {
//             RequestFilterFields = "Statement No.";
//             column(BankCode; BankCode)
//             {
//             }
//             column(BankAccountNo_BankAccReconciliation; BankAccRecon."Bank Account No.")
//             {
//             }
//             column(StatementNo_BankAccReconciliation; BankAccRecon."Statement No.")
//             {
//             }
//             column(StatementDate_BankAccReconciliation; BankAccRecon."Statement Date")
//             {
//             }
//             column(BankAccountNo; BankAccountNo)
//             {
//             }
//             column(StatementEndingBalance_BankAccReconciliation; BankAccRecon."Statement Ending Balance")
//             {
//             }
...
//                 begin
//                     //Reconciled=CONST(No)
//                     //BankAccountLedgerEntry.SETFILTER("Posting Date",'<=%1',BankAccRecon."Statement Date");
//                     SETFILTER("Posting Date", '%1..%2', 01010101D, BankAccRecon."Statement Date");
...
//                 begin
//                     //Reconciled=CONST(No)
//                     //BankAccountLedgerEntry1.SETFILTER("Posting Date",'<=%1',BankAccRecon."Statement Date");
//                     SETFILTER("Posting Date", '%1..%2', 01010101D, BankAccRecon."Statement Date");
//                     SETFILTER("Statement Status", '%1', "Statement Status"::Open);
...
//             trigger OnAfterGetRecord()
//             var
//                 BankAccountLedgerEntry2: Record "271";
//                 BankAccountRecLine: Record "274";
//             begin
//                 BankCode:='';
//                 BankAccountNo:='';
//                 BankName:='';
...
//                   BankAccountLedgerEntry2.SETFILTER("Posting Date",'%1..%2','010101D',BankAccRecon."Statement Date");
//                   //BankAccountLedgerEntry2.SETFILTER("Statement Difference",'<>%1',0);
//                   IF BankAccountLedgerEntry2.FIND('-') THEN REPEAT
...
//                  BankStatBalance:=BankAccRecon."Statement Ending Balance";
                
//                 BankAccReconciliationLine.RESET;
//                 BankAccReconciliationLine.SETRANGE(BankAccReconciliationLine."Bank Account No.",BankAccRecon."Bank Account No.");
//                 BankAccReconciliationLine.SETRANGE(BankAccReconciliationLine."Statement No.",BankAccRecon."Statement No.");
...
//                 BankAccReconciliationLine2.SETRANGE(BankAccReconciliationLine2."Bank Account No.",BankAccRecon."Bank Account No.");
//                 BankAccReconciliationLine2.SETRANGE(BankAccReconciliationLine2."Statement No.",BankAccRecon."Statement No.");
...
//                   ELSE IF BankAccReconciliationLine2.Difference<0 THEN
...
//                 BankAccReconciliationLine1.SETRANGE(BankAccReconciliationLine1."Bank Account No.",BankAccRecon."Bank Account No.");
//                 BankAccReconciliationLine1.SETRANGE(BankAccReconciliationLine1."Statement No.",BankAccRecon."Statement No.");
//                 BankAccReconciliationLine1.SETFILTER(Difference,'<>%1',0);
...
//                 //myDifferences :=  (BankAccRecon."Statement Ending Balance"-UnpresentedChequesTotal-DifferencesInBankTotalDebits+DifferencesInBankTotalCredits+UncreditedBanking)-(BankAccountBalanceasperCashBook);
...
//     trigger OnPreReport()
//     begin
//         //BankAccReconFilter := BankAccRecon.GETFILTERS;
//     end;
...
//         BankRecPresented.SETRANGE(BankRecPresented."Bank Account No.",BankAccRecon."Bank Account No.");
//         BankRecPresented.SETRANGE(BankRecPresented."Statement No.",BankAccRecon."Statement No.");
