report 52178517 "Cost Center W (Product Group)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/SSR/CostCenterWProductGroup.rdlc';
    ApplicationArea = ALL;
    ...
    dataset
    {
        dataitem("Store Requistion Lines"; "PROC-Store Requistion Lines")
        {
            ...
            dataitem("PROC-Store Requistion Header"; "PROC-Store Requistion Header")
            {
                column(posting_date; "Issue Date")
                {
