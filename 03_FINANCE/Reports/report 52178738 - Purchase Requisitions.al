report 52178738 "Purchase Requisitions"
{
    ...
    dataset
    {
        dataitem(ph; "Purchase Header")
        {
            ...
            column(CompanyInfoName; info.Name)
            {
            }
            column(CompanyInfoAddress; info.Address)
            {
            }
            column(CompanyInfoPicture; info.Picture)
            {
            }
            column(CompanyInfoPhone1; info."Phone No.")
            {
            }
            column(CompanyInfoPhone2; info."Contact Person")
            {
            }
            column(CompanyInfoAdress; info.Address)
            {
            }
            column(CompanyInfoPostal; info."Post Code")
            {
            }
            column(CompanyInfoEmail; info."E-Mail")
            {
            }
            column(CompanyInfoWebpage; info."Home Page")
            {
            }
            column(CompanyInfoCity; info.City)
            {
            }
