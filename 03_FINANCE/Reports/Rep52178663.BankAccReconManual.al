report 52178663 "Bank Acc. Recon. - Manual"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("BankAccReconciliation"; "Bank Acc. Reconciliation")
        {
            ...
            column(StatementDate_BankAccReconciliation;StatementDate_BankAccReconciliation)
            {
            }
            ...
            dataitem(BankAccountLedgerEntry; 271)
            {
                ...
                begin
                    SNo += 1;
                    StatementDate_BankAccReconciliation :=StatementDate."Statement Date"
                end;
    ...
    var
        ...
        StatementDate : Record "Bank Acc. Reconciliation";
        StatementDate_BankAccReconciliation : Date;
