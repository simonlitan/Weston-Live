    ...
    dataset
    {
        dataitem(Receipt_Header; "FIN-Receipts Header")
        {
            ...
            dataitem(Receipt_Line; "FIN-Receipt Line q")
            {
                ...
                dataitem(LedgEntry; "Cust. Ledger Entry")
                {
                    CalcFields = Amount;
                    DataItemLink = "Customer No." = field("Account No."), "Document No." = field(No);
                    column(EntryNo_LedgEntry; "Entry No.")
                    {
                    }
                    column(DocumentNo_LedgEntry; "Document No.")
                    {
                    }
                    column(Amount_LedgEntry; Amount)
                    {
                    }
                    dataitem(vendLedger; "Cust. Ledger Entry")
                    {
                        ...
                        column(ExternalDocumentNo_vendLedger; "Document No.")
                        {
                        }
                        column(ClosedbyAmount_vendLedger; Amount)
                        {
                        }
                        column(EntryNo_vendLedger; "Entry No.")
                        {
                        }

                    }

                    dataitem(ledgEntry2; "Cust. Ledger Entry")
                    {
                        CalcFields = Amount;
                        DataItemLink = "Customer No." = field("Customer No."), "Closed by Entry No." = field("Entry No.");
                        column(DocumentNo_ledgEntry2; "Document No.")
                        {
                        }
                        column(EntryNo_ledgEntry2; "Entry No.")
                        {
                        }
                        column(Amount_ledgEntry2; Amount)
                        {
                        }
                        column(ClosedbyAmount_ledgEntry2; "Closed by Amount")
                        {
                        }



                        dataitem(dledgEntry; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(DocumentNo_dledgEntry; "Document No.")
                            {
                            }
                            column(EntryNo_dledgEntry; "Entry No.")
                            {
                            }
                            column(Amount_dledgEntry; Amount)
                            {
                            }
                            column(PostingDate_dledgEntry; "Posting Date")
                            {
                            }
                        }
