table 52178783 "NW-Board Members"
{
    ...
    fields
    {
        ...
        field(60041; "Mileage Rate"; Decimal)
        {
            FieldClass = FlowField;
        ...
        field(60042; "Mileage Ceiling"; Decimal)
        {
            FieldClass = FlowField;
