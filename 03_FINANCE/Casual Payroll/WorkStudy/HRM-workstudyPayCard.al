page 52178560 "PRL-WorkStudy Pay Card"
{
    ...
    SourceTableView = SORTING("No.")
                      ORDER(Ascending)
                      WHERE("Employee Category" = FILTER('CASUAL'));
    ...
    layout
    {
        area(content)
        {
            ...
            part("Wage Computations"; "PRL-WorkStudy Worked Hours")
            {
                ApplicationArea = all;
    ...
    actions
    {
        ...
        area(reporting)
        {
            ...
            action("NSSF - Casual")
            {
                ...
                Caption = 'NSSF - Casual';
                Image = Payables;
                //todo  RunObject = Report "Casual-NSSF";
            }
            action("Casual - Payroll Summary")
            {
                ...
                Image = Giro;
                //todo  RunObject = Report "Casual Payroll Summary";
            }
            action("Casual-Deductions Summar 2")
            {
                ...
                Image = "Report";
                Promoted = true;
                //todo RunObject = Report "Casual-Deductions Summary 2";
            }
            action("Casual - Payments Summary")
            {
                ...
                Promoted = true;
                PromotedIsBig = true;
                //todo   RunObject = Report "Casual - Payments Summary";
            }
            action("Casual - NHIF Report 2")
            {
                ...
                Image = "Report";
                Promoted = true;
                //todo   RunObject = Report "Casual - NHIF Report";
            }
            action("Casual - NSSF Report (A)")
            {
                ...
                Image = "Report";
                Promoted = true;
                //todo   RunObject = Report "Casual - NSSF Report (A)";
            }
            action("Casual PAYE Schedule")
            {
                ...
                Promoted = true;
                PromotedIsBig = true;
                //todo  RunObject = Report "Casual - PAYE Schedule";
            }
            action("Casual Summary 1")
            {
                ...
                Image = Report;
                Promoted = true;
                //todo RunObject = Report "Casuals Summary Report";
            }
            action("Casual-NSSF Report (B)")
            {
                ...
                Image = "Report";
                Promoted = true;
                //todo RunObject = Report "Casual-NSSF Report (B)";
            }
            action("Casuals P9")
            {
                ApplicationArea = All;
                ...
                //todo  RunObject = Report "P9 Report (Final) Casual";
            }
        }
        area(processing)
        {
            action(ProcessPayroll)
            {
                ...
                var
                    ...
                    PRLEmployeeDaysWorked: Record "PRL Workstudy Hours Worked";
                    StdDailyRate: Decimal;
                    prempTrns2: Record "PRL-Casual Emp. Transactions";
                begin
                    ContrInfo.Get;

                    if Confirm('This will process salaries for WorkStudy Employees, Continue?', false) = false then exit;
                    ...
                    HrEmployee.SetFilter(HrEmployee."Employee Category", '%1|%2', 'WORKSTUDY', 'WORKSTUDY');
                                    ...
                                    */
                                    ...
                                    if salaryCard.Find('-') then begin
                                        ...
                                        /* IF salaryCard."Suspend Pay"<>TRUE THEN BEGIN
                                         ...
                                         ELSE BEGIN*/
                                        ProcessPayroll.fnProcesspayroll(HrEmployee."No.", DOJ, (salaryCard."Hours Worked" * salaryCard."Hourly Rate"), false
    ...
    var
        ...
        SalCard: Record "PRL Workstudy Hours Worked";
        ...
        salaryCard: Record "PRL Workstudy Hours Worked";
        dateofJoining: Date;
        dateofLeaving: Date;
        GetsPAYERelief: Boolean;
        DOJ: Date;
        SalCard2: Record "PRL Workstudy Hours Worked";
}
