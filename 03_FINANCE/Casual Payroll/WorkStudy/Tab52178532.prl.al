table 52178532 "PRL Workstudy Hours Worked" 
{
    ...
    fields
    {
                        ...
                        if HRMEmployee.Find('-') then begin
                            if HRMEmployee."Employee Category" = 'CASUALS' then begin
                                ...
                                if CasualsAttendanceLedger.Find('-') then begin
                                    "Computed Hours" := CasualsAttendanceLedger.Count;
                                end;
                            end else begin
                            end;
                        end;
        ...
        field(5; "Computed Hours"; Integer)
        {
        }
