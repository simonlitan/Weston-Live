table 50011 "Performan Criteria Line Casc 1"
{
    ...
    trigger OnInsert()
    begin
        PerfCriteriCascade1.RESET;
        PerfCriteriCascade1.SETRANGE(PerfCriteriCascade1."Performance Criteria Code", "Activity Code");
        IF PerfCriteriCascade1.FIND('-') THEN
            Departments := PerfCriteriCascade1.Departments;
        Directorates := PerfCriteriCascade1.Directorates;
    end;

    var
        Performance: Record "Performance Criteria Code";
        PerformanceStep: Record "Performance Criteria Step Code";
        PerfCriteriCascade1: Record "Performance Criteria Cascade 1";
}
