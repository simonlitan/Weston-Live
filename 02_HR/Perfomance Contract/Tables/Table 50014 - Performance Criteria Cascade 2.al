table 50014 "Performance Criteria Cascade 2"
{
    DrillDownPageID = "Criterial Line Cascade 2";
    LookupPageID = "Criterial Line Cascade 2";
    ...
    fields
    {
        ...
        {
            TableRelation = "Performance Criteria Cascade 1"."Performance Criteria Code";
        ...
        field(50012; "PCC2 Status"; Option)
        {
    ...
    fieldgroups
    {
        fieldgroup(ContractPeriod; "Contract Period")
        {
        }
        fieldgroup(Departments; Departments)
        {
        }
    }
    ...
    var
        ...
        PerfCriteriaLineCasc: Record "Perfmnc Criteria Line Cascade2";
        PerfCriteriaLine: Record "Performan Criteria Line Casc 1";
        LineNo: Decimal;
        lastno: Integer;
