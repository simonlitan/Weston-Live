table 50020 "Performance Criteria Cascade 5"
{
    DrillDownPageID = "Criterial Line Cascade 5";
    LookupPageID = "Criterial Line Cascade 5";
    ...
    fields
    {
        ...
        {
            TableRelation = "Performance Criteria Cascade 4"."Performance Criteria Code";
        ...
        field(50012; "PCC5 Status"; Option)
        {
    ...
    keys
    {
        key(Key1; "Performance Criteria Code")
        {
        }
        key(Key2; "Performance Criter Description", Departments, Directorates)
        {
        }
    }
    ...
    var
        ...
        PerfCriteriaLineCasc: Record "Perfmnc Criteria Line Cascade5";
        PerfCriteriaLine: Record "Perfmnc Criteria Line Cascade4";
        LineNo: Decimal;
        lastno: Integer;
        PerfCriteriaLineCasc1: Record "Perfmnc Criteria Line Cascade5";
}
