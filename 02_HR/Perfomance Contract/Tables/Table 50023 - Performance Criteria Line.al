table 50023 "Performance Criteria Line"
{
    ...
    trigger OnInsert()
    begin
        PerformanceCriteria.RESET;
        PerformanceCriteria.SETRANGE(PerformanceCriteria."Performance Criteria Code", "Activity Code");
        IF PerformanceCriteria.FIND('-') THEN BEGIN
            "Contract Period" := PerformanceCriteria."Contract Period";
        END;
    end;
    ...
    var
        ...
        PerformanceCriteria: Record "Performance Criteria";
}
