page 68501 "Appraisal Header DDHR List"
{
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            group("TO BE COMPLETED BY EMPLOYEE")
            {
                ...
                {
                    Caption = '(c) Please List extra-Curicula activities to which you have been involved in the KEFRI';
                    MultiLine = true;
                    ApplicationArea = All;
                }
            ...
            part("TO BE COMPLETED BY HOD"; "HR Appraisal Objectives")
            {
