Page 68499 "Appraisal Full Board List"
{
    PageType = List;
    SourceTable = "Appraisal Card";
    SourceTableView = WHERE(Status = FILTER("Full Board"));
    ...
    layout
    {
        area(content)
        {
            ...
            part("HR Appraisal Objectives"; "HR Appraisal Objectives")
            {
            ...
            group(Functions)
            {
                ...
                action("Send to HR")
                {
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want send to Full Board this appraisal') THEN BEGIN
                            Rec.Status := Rec.Status::"Full Board";
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been successfully sent to Full Board', Rec."Appraisal Code");
                        END;
                    end;
                }
                action("Send Back to HOD")
                {
                    Caption = 'Send Back to Supervisor';
                    Image = OpenWorksheet;
                    Promoted = true;
                    PromotedCategory = Category5;
                    PromotedIsBig = true;
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to return this appraisal form to you supervisor?') THEN BEGIN
                            Rec.Status := Rec.Status::Supervisor;
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been send back to the Supervisor', Rec."Appraisal Code");
                        END;
                    end;
                }
            }
