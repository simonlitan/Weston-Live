page 68502 "Appraisal Supervisor"
{
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    Caption = '11.(a) Please List the challenges you have experienced during the period while performing your duties specifically in the following areas;(i)While dealing with clients';
                    MultiLine = true;
                    ApplicationArea = All;
                }
                ...
                {
                    Caption = '(c) Please List extra-Curicula activities to which you have been involved in the Institute';
                    MultiLine = true;
                    ApplicationArea = All;
                }
                field(Text9; Rec.Text9)
                {
                    Caption = '(d) Please list the Institute committees/working parties you have been involved in during your Current  contract';
                    MultiLine = true;
                    ApplicationArea = All;
                }
            ...
            group(Functions)
            {
                ...
                action("Send to HR")
                {
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to send this appraisal form to you DDHR?') THEN BEGIN
                            Rec.Status := Rec.Status::DDHR;
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been to the HR for moderation', Rec."Appraisal Code");
                        END;
                    end;
                }
                action("Return to the Appraisee")
                {
                    Caption = 'Return to the Appraisee';
                    Image = OpenWorksheet;
                    Promoted = true;
                    PromotedCategory = Category5;
                    PromotedIsBig = true;
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to send this appraisal form to the appraisee?') THEN BEGIN
                            Rec.Status := Rec.Status::Appraisee;
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been returned to appraisee', Rec."Appraisal Code");
                        END;
                    end;
                }
                action("Send to JSAC/SSASC")
                {
                    Caption = 'Send to JSAC/SSASC';
                    Image = OpenWorksheet;
                    Promoted = true;
                    PromotedCategory = Category5;
                    PromotedIsBig = true;
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to send this appraisal form to you JSAC/SSASC?') THEN BEGIN
                            Rec.Status := Rec.Status::"JSAC/SSASC";
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been send JSAC/SSASC to for Review', Rec."Appraisal Code");
                        END;
                    end;
                }
                action("Send to HOD")
                {
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to send this appraisal form to HOD?') THEN BEGIN
                            Rec.Status := Rec.Status::Moderation;
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been send HOD to for Moderation', Rec."Appraisal Code");
                        END;
                    end;
                }
            }
