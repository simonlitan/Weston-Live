            ...
            group(Functions)
            {
                ...
                action("Send to HR")
                {
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to close this appraisal') THEN BEGIN
                            Rec.Status := Rec.Status::"Closed/HR";
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been successfully closed', Rec."Appraisal Code");
                        END;
                    end;
                }
                action("Send Back to HOD")
                {
                    Caption = 'Send Back to HOD';
                    Image = OpenWorksheet;
                    Promoted = true;
                    PromotedCategory = Category5;
                    PromotedIsBig = true;
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to return this appraisal form to your HOD?') THEN BEGIN
                            Rec.Status := Rec.Status::Moderation;
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been send back to the HOD', Rec."Appraisal Code");
                        END;
                    end;
                }
                action("Send to JSAC/SSASC")
                {
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to send to JSAC/SSASC?') THEN BEGIN
                            Rec.Status := Rec.Status::"JSAC/SSASC";
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been send to JSAC/SSASC', Rec."Appraisal Code");
                        END;
                    end;
                }
                action("Send to Full Board")
                {
                    Caption = 'Send Back to Full Board';
                    Image = OpenWorksheet;
                    Promoted = true;
                    PromotedCategory = Category5;
                    PromotedIsBig = true;
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to send to Full Board?') THEN BEGIN
                            Rec.Status := Rec.Status::"Full Board";
                            Rec.MODIFY;
                            MESSAGE('Appraisal  Number %1 has been send to Full Board', Rec."Appraisal Code");
                        END;
                    end;
                }
            }
