            ...
            group(Functions)
            {
                ...
                action("Send Back to HOD")
                {
                    ...
                    begin
                        ...
                        IF CONFIRM('Are you sure you want to return this appraisal form to you DDHR?') THEN BEGIN
