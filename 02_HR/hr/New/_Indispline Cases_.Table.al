table 50066 "Indispline Cases"
{
    fields
    {
        ...
        field(3;"Indispline Code";Code[20])
        {
            ...
            trigger OnValidate()var IndicplineCasessetup: Record "Indicpline Cases setup";
            begin
        ...
        field(6;"Staff No";Code[20])
        {
            ...
            trigger OnValidate()var HRMEmployee: Record "HRM-Employee C";
            begin
                IF HRMEmployee.GET(Rec."Staff No")THEN Rec."Staff Name":=HRMEmployee."First Name" + ' ' + HRMEmployee."Middle Name" + ' ' + HRMEmployee."Last Name";
            end;
        }
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Dimension Value".Code WHERE("Dimension Code"=FILTER('DEPARTMENTS'), "Global Dimension No."=FILTER(2));
        }
        field(9;"Department Name";Text[100])
        {
            CalcFormula = Lookup("Dimension Value".Name WHERE("Global Dimension No."=FILTER(2), Code=FIELD("Department Code")));
            Editable = false;
    ...
    var HRMEmployee: Record "HRM-Employee C";
