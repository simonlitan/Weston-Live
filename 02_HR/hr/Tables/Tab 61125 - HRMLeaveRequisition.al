...
{
    DrillDownPageID = "HRM-Leave Requisition List";
    LookupPageID = "HRM-Leave Requisition List";
    ...
    fields
    {
        ...
        field(7; "Applied Days"; Decimal)
        {
            ...
            begin
                ...
                if ("Applied Days" <> 0) and ("Starting Date" <> 0D) then begin
                    /* if "Total Off Days" > 0 then
                        "Applied Days" := "Applied Days" + "Total Off Days"; */
        ...
        field(8; "Starting Date"; Date)
        {
            ...
            begin
                ...
                if ("Applied Days" <> 0) and ("Starting Date" <> 0D) then begin
                    if "Total Off Days" >= 0 then
                       TotalDays :=  "Applied Days" + "Total Off Days";
                    "End Date" := CalcEndDate("Starting Date", TotalDays);
                    "Return Date" := CalcReturnDate("End Date");
        ...
        field(38; "Pending Off Days"; Code[20])
        {
             TableRelation = "HR Off Days".Day;
            //OptionMembers = ,Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday;
            trigger OnValidate()
            begin
                "Applied Days" := "Applied Days" + 1;
        ...
        field(16; "Responsibility Center"; Code[20])
        {
            ...
            TableRelation = "Responsibility Center".code where(Grouping = filter('Leave'));
        ...
        field(37; "Total Off Days"; Decimal)
        {
            DecimalPlaces = 1 : 1;
            DataClassification = ToBeClassified;
            trigger OnValidate()
