report 51850 "Payroll Summary 3"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Group Order") ORDER(Ascending) WHERE("Group Order" = FILTER(1 |2| 3 | 4 |6| 7 | 8 | 9 | 12|16));
            ...
            var
                Str: Text;
            begin
                Str := CopyStr("Employee Code", 1, 1);
                if Str = 'C' then CurrReport.Skip();
                TotalEmployees := 0;
                HRMEmployeeD.Reset;
                ...
                if HRMEmployeeD.Find('-') then begin
                    // if HRMEmployeeD."Payroll Code" = 'CASUAL' then
                    //     CurrReport.Skip();
                    // // else
                    // //     SerialNo := SerialNo + 1;///
            ...
            begin
                // SetRange("PRL-Period Transactions"."Payroll Code", 'SALARY');
