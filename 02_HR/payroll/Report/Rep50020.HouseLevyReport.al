report 50020 "House Levy Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './payroll/Report/SSR/HouseLevy.rdl';
    ...
    dataset
    {
        dataitem("PRL-Employee P9 Info"; "PRL-Employee P9 Info")
        {
            ...
            column(EmpPin; objEmp."PIN Number" )
            {
    ...
    var
        ...
        Prepared_by_______________________________________Date_________________CaptionLbl: Label 'Prepared by..                 DateÙÙÙÙÙÙÙÙ';
        Checked_by________________________________________Date_________________CaptionLbl: Label 'Checked byÙÙÙÙÙÙ..                   DateÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙ';
