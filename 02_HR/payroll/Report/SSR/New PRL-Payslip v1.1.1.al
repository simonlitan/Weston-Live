report 50017 "PRL-Payslips V 1.1.1 backup"
{
    DefaultLayout = RDLC;
    RDLCLayout = './payroll/Report/SSR/PRL-Payslips V 1.1.1 backup.rdl';
    ...
    dataset
    {
        ...
        dataitem("PRL-Period Transactions"; "PRL-Period Transactions")
        {
            ...
            column(EmpNo; HRMEmployeeC."No.")
            {
            }
            column(JobTitle_HRMEmployeeC; HRMEmployeeC."Job Title")
            {
            }
            column(SalaryGrade_HRMEmployeeC; HRMEmployeeC."Salary Grade")
            {
            }
            column(Names; HRMEmployeeC."Last Name" + ' ' + HRMEmployeeC."Middle Name" + ' ' + HRMEmployeeC."First Name")
            {
            }
            column(DOJ; HRMEmployeeC."Date Of Join")
            {
            }
            column(UserId; "Userid")
            {
            }
            column(Age_HRMEmployeeC; HRMEmployeeC.Age)
            {
            }
            column(IDnNHIF; strID + strNhifNo)
            {
            }
            column(PinNo; HRMEmployeeC."PIN Number")
            {
            }
            column(Retirement_date; HRMEmployeeC."Retirement date")
            {
            ...
            column(BankName; HRMEmployeeC."Main Bank Name")
            {
            }
            column(BankBranch; HRMEmployeeC."Branch Bank Name")
            {

            }
            column(NSSF; HRMEmployeeC."NSSF No.")
            {

            }
            column(DepartmentName_HRMEmployeeC; HRMEmployeeC."Department Name")
            {
            }
            column(NHIF; HRMEmployeeC."NHIF No.")
            {

            }
            column(AccNo; HRMEmployeeC."Bank Account Number")
            {
            }
            ...
            begin
                ...
                if objEmp.Find('-') then begin
                    ...
                    if ((objEmp."Date Of Birth" <> 0D) and (objPeriod."Date Opened" <> 0D)) then
                        strAge := HrDate.DetermineAge_Years(HRMEmployeeC."Date Of Birth", objPeriod."Date Opened");
