codeunit 50119 "prPayrollProcessing"
{
    ...
    var
        ...
        TaxAccount: Code[20];
        JrnBalAcc: Code[30];
        TaxBalAccount: Code[20];
        salariesAcc: Code[20];
        salariesBalAcc: Code[20];
        salBalAcc: Code[20];
        PayablesAcc: Code[20];
        NSSFEMPyer: Code[20];
        NSSFEMPyerBal: Code[20];
        PensionEMPyer: Code[20];
        NSSFEMPyee: Code[20];
        NSSFEMPyeeBal: Code[20];
        NHIFEMPyer: Code[20];
        NHIFEMPyee: Code[20];
        NHIFEMPyeeBal: Code[20];
        SHIFEmpyee: Code[20];
    ...
    begin
        ...
        HlevyRelief := VitalSetup."Hlevy relief";
        // SHIFRelief := VitalSetup."Shif Relief";
    ...
    begin
        ...
        begin
            ...
            salariesAcc, JournalPostAs::Debit, JournalPostingType::"G/L Account", '', CoopParameters::none, salariesBalAcc);
            ...
            if prSalaryArrears.Find('-') then begin
                repeat
                    ...
                    fnUpdatePeriodTrans(strEmpCode, prSalaryArrears."Transaction Code", TGroup, TGroupOrder, TSubGroupOrder,
                      ...
                      JournalPostAs::Debit, JournalPostingType::"G/L Account", '', CoopParameters::none, salariesBalAcc);
                    ...
                    fnUpdatePeriodTrans(strEmpCode, 'PYAR', TGroup, TGroupOrder, TSubGroupOrder,
                       ...
                       TaxAccount, JournalPostAs::Debit, JournalPostingType::"G/L Account", '', CoopParameters::none, TaxBalAccount)
                ...
                repeat
                    ...
                    if prTransactionCodes.Find('-') then begin
                        ...
                        if prTransactionCodes.Subledger <> prTransactionCodes.Subledger::" " then begin
                            ...
                            salBalAcc := prTransactionCodes."Balancing Account";
                        ...
                        prTransactionCodes."coop parameters", salBalAcc);
            ...
            If PRLSalaryCard.find('-') Then Begin
                ...
                //  fnUpdatePeriodTrans(strEmpCode, 'SHIF', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth, intYear, '', prPeriodTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none, '1356');
                ...
                fnUpdatePeriodTrans(strEmpCode, 'SHIF', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
                                 ...
                                 NHIFEMPyee, JournalPostAs::Credit, JournalPostingType::"G/L Account", '',
                                  CoopParameters::none, NHIFEMPyeeBal);
                fnUpdatePeriodTrans(strEmpCode, 'Nita', 'Nita EMPLOYER', 12, 0, 'NITA EMPLOYER', 50,
                             0, intMonth, intYear, '', '', SelectedPeriod, Dept, '1364', JournalPostAs::" ",
                             JournalPostingType::" ", '', CoopParameters::none, '2459');
            end;
            ...
            /* 
                        //Nita Modification
                        fnUpdatePeriodTrans(strEmpCode, 'Nita', 'Nita', 12, 0, 'Nita Contribution', 50, 0, intMonth, intYear, '', '', SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                        ...
                        IF HREmp2.Find('-') then begin
                            if ((HREmp2."Gratuity Wth Voluntary Pension") and (HREmp2."Employee Pension %" <> 0)) then begin
                                ...
                                fnUpdatePeriodTrans(strEmpCode, 'Gratuity', 'Gratuity', 13, 0, 'Gratuity', gratuityAmount, 0, intMonth, intYear, '', '', SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                                gPensionAmount := curBasicPay * (0.2 - gPensionPer);
                                //Employer pension Contribution with gratuity
                                fnUpdatePeriodTrans(strEmpCode, 'GEmprPension', 'GEmprPension', 15, 0, '15% Employer Pension', gPensionAmount, 0, intMonth, intYear, '', '', SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                            end
                            else begin
            ...
            if HREmp2.Find('-') then begin
                ...
                if empPeriod.Find('-') then begin
                    ...
                    if empTr.Find('-') then begin
                        ...
                        fnUpdatePeriodTrans(strEmpCode, 'NEmprPension', 'NEmprPension', 14, 0, '20% Employer Pension', EmpPensionContrib, 0, intMonth, intYear, '', '', SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none);
                    end
                    else begin
            ...
            IF blnPaysNssf THEN begin
                ...
                TGroupOrder := 7;
                TSubGroupOrder := 1;
                fnUpdatePeriodTrans(strEmpCode, 'NSSF(I)', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth, intYear, '', '',
                SelectedPeriod, Dept, NSSFEMPyee, JournalPostAs::Credit, JournalPostingType::"G/L Account", '',
                 CoopParameters::NSSF, NSSFEMPyeeBal);
                ...
                TGroupOrder := 7;
                TSubGroupOrder := 1;
                fnUpdatePeriodTrans(strEmpCode, 'NSSF(II)', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
                 curTransAmount, 0, intMonth, intYear, '', '', SelectedPeriod, Dept, NSSFEMPyee,
                  JournalPostAs::Credit, JournalPostingType::"G/L Account", '', CoopParameters::NSSF, NSSFEMPyeeBal);
                //NSSF EMPLOYER
                curNSSF := fnGetEmployeeNSSFTierI(curGrossPay) + fnGetEmployeeNSSFTierII(curGrossPay);
                curTransAmount := curNSSF;
                fnUpdatePeriodTrans(strEmpCode, 'NSSF EMPLOYER', 'NSSF EMPLOYER', 11, 0, 'NSSF EMPLOYER', curTransAmount,
                0, intMonth, intYear, '', '', SelectedPeriod, Dept, NSSFEMPyer, JournalPostAs::" ",
                JournalPostingType::" ", '', CoopParameters::none, NSSFEMPyerBal);
            end;
            if blnPaysNssf then begin
                ...
                curNSSF := fnGetEmployeeNSSFTierI(curGrossPay);
                curTransAmount := curNSSF;
                fnUpdateEmployerDeductions(strEmpCode, 'NSSF(I) Employer', 'EMP', TGroupOrder, TSubGroupOrder, '', curTransAmount, 0, intMonth, intYear, prEmployeeTransactions.Membership, prEmployeeTransactions."Reference No", SelectedPeriod);
                curNSSF := fnGetEmployeeNSSFTierII(curGrossPay);
                curTransAmount := curNSSF;
                fnUpdateEmployerDeductions(strEmpCode, 'NSSF(II) Employer', 'EMP', TGroupOrder, TSubGroupOrder, '', curTransAmount, 0, intMonth, intYear, prEmployeeTransactions.Membership, prEmployeeTransactions."Reference No", SelectedPeriod);
                ...
                fnUpdatePeriodTrans(strEmpCode, 'DEFCON1', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount,
                 0, intMonth, intYear, '', '', SelectedPeriod, Dept, NSSFEMPyee, JournalPostAs::" ",
                 JournalPostingType::" ", '', CoopParameters::none, NSSFEMPyeeBal);
                ...
                TGroupOrder := 6;
                TSubGroupOrder := 1; //CHANGE tax calculations TO APYE INFORMATION-HOSEA // change TGroupOrder :=6 to 7
                fnUpdatePeriodTrans(strEmpCode, 'DEFCON2', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
                 curTransAmount, 0, intMonth, intYear, '', '', SelectedPeriod, Dept, NSSFEMPyee, JournalPostAs::" ",
                  JournalPostingType::" ", '', CoopParameters::none, NSSFEMPyeeBal);
            end;
            ...
            //Update Employer deductions//Litan
            /*  if blnPaysNssf then
           ...
           SpecialTransType::"Defined Contribution", FALSE);//Self contrib Pension is 1 on [Special Transaction]
            ...
            if blnPaysPaye and blnGetsPAYERelief then begin
                ...
                //Get SHIF Relief
                // SHIFRelief := (curGrossPay * 0.0275) * 0.15; //SHIF is 3 on [Special Transaction]
                ...
                // TGroupOrder := 6;
                // TSubGroupOrder := 8;   //CHANGE tax calculations TO PAYE INFORMATION -HOSEA // change TGroupOrder :=6 to 7
                // fnUpdatePeriodTrans(strEmpCode, 'SHIFF Relief', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
                // curTransAmount, 0, intMonth, intYear, '', '', SelectedPeriod, Dept,
                // '', JournalPostAs::Credit, JournalPostingType::" ", '', CoopParameters::none, '');
            ...
            if (curReliefPersonal + curInsuranceReliefAmount) > curMaximumRelief then begin
                ...
                if (blnInsuranceCertificate) then begin
                    // HlevyRelief := 0.00225 * curGrossPay;//15% of housing Levy.........hlevy is 1.5% of grosspay.....1.5% of 15% of Gpay//Litan
           ...
           curPAYE := curTaxCharged - (curReliefPersonal + curInsuranceReliefAmount);
            ...
            fnUpdatePeriodTrans(strEmpCode, 'PAYE', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
             ...
             JournalPostingType::"G/L Account", '', CoopParameters::none, TaxBalAccount);
            ...
            // PRLSalaryCard.Reset();
            // PRLSalaryCard.setrange("Employee Code", strEmpCode);
            // PRLSalaryCard.setrange("Housing levy", True);
            // If PRLSalaryCard.find('-') Then Begin
            //     CurHlevy := GetHlevy(curGrossPay);
            //     curTransAmount := CurHlevy;
            //     strTransDescription := 'Hlevy';
            //     TGroup := 'STATUTORIES';
            //     TGroupOrder := 6;
            //     TSubGroupOrder := 2;
            // fnUpdatePeriodTrans(strEmpCode, 'SHIF', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription, curTransAmount, 0, intMonth, intYear, '', prPeriodTransactions."Reference No", SelectedPeriod, Dept, '', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none, JrnBalAcc);

            //     fnUpdatePeriodTrans(strEmpCode, 'Housing Levy', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
            //    curTransAmount, 0, intMonth, intYear, '', '', SelectedPeriod, Dept,
            //    NHIFEMPyee, JournalPostAs::Credit, JournalPostingType::"G/L Account", '',
            //     CoopParameters::none, JrnBalAcc);
            ...
            empTr.SetFilter("Transaction Code", '%1', 'D026');
            if empTr.Find('-') then begin

                fnUpdatePeriodTrans(strEmpCode, 'HE-Levy', 'HE-Levy', 16, 0, 'Housing Levy Employer Contrib', curGrossPay * 0.015 + empTr.Amount, 0, intMonth,
                intYear, '', '', SelectedPeriod, Dept, '2460', JournalPostAs::" ", JournalPostingType::" ", '', CoopParameters::none, JrnBalAcc);
                ...
                repeat
                    ...
                    if prTransactionCodes.Find('-') then begin
                        ...
                        if (prTransactionCodes."Special Transactions" = prTransactionCodes."Special Transactions"::"Defined Contribution") then
                            if prTransactionCodes.Pension = true then begin
                                curTransAmount := curPensionStaff;
                                fnUpdateEmployerDeductions(strEmpCode, prTransactionCodes."Transaction Code" + '-PEN-EMPLOYER',
                                'EMP', TGroupOrder, TSubGroupOrder, '', curTransAmount, 0, intMonth, intYear,
                                prEmployeeTransactions.Membership, prEmployeeTransactions."Reference No", SelectedPeriod);
                            end;
                        ...
                        if (prTransactionCodes."Special Transactions" = prTransactionCodes."Special Transactions"::"Staff Loan") then begin
                            ...
                            if (curLoanInt <> 0) then begin
                                ...
                                fnUpdatePeriodTrans(strEmpCode, strTransCode, TGroup, TGroupOrder, TSubGroupOrder,
                                  ...
                                  CoopParameters::"loan Interest", salBalAcc)
                            end;
    ...
    begin
        ...
        prPeriodTransactions."Journal Bal Acc" := JrnBalAcc;
        //Paymode
        ...
        if prEmployeeTransactions.Find('-') then begin
            repeat
                ...
                if (prTransactionCodes.Frequency = prTransactionCodes.Frequency::Fixed) and
                 ...
                 begin
                    // if (curTransAmount <> 0) then  //Update the employee transaction table simba
                    // begin
                    ...
                    // VET
                    if (prEmployeeTransactions."Transaction Code" = VitalSetup."Credit Trans. Code") then begin
            ...
            if prsalCard.Find('-') then begin
                ...
                if not (prsalCard3.Get(prsalCard."Employee Code", dtNewPeriod)) then begin // Insert the Basic salary details for the current Month
                    ...
                    prsalCard3.SHIF := prsalCard.SHIF;
    ...
    procedure fnGetNegativePay(intMonth: Integer;
            intYear: Integer;
            dtOpenPeriod: Date)
    var
        prPeriodTransactions: Record "PRL-Period Transactions";
                            ...
                            7: //Statutories
                                begin
                                    if prPeriodTransactions."Sub Group Order" = 1 then begin
                                        if (prPeriodTransactions."Sub Group Order" = 1) and (prPeriodTransactions."Transaction Code" = 'NSSF(I)') then
                                            P9NSSF1 := prPeriodTransactions.Amount else
                                            if (prPeriodTransactions."Sub Group Order" = 1) and (prPeriodTransactions."Transaction Code" = 'NSSF(II)') then
    ...
    begin
        ...
        if SalaryCard.Get(strEmpCode) then begin
            if PostingGroup.Get(SalaryCard."Posting Group") then begin
                ...
                TaxBalAccount := PostingGroup."Tax Bal/Acc";

                salariesAcc := PostingGroup."Salary Account";
                salariesBalAcc := PostingGroup."Salary Bal/ACC";

                PayablesAcc := PostingGroup."Net Salary Payable";
                NSSFEMPyer := PostingGroup."NSSF Employer Account";
                NSSFEMPyerBal := PostingGroup."NSSF Employer Bal Acc";

                NSSFEMPyee := PostingGroup."NSSF Employee Account";
                NSSFEMPyee := PostingGroup."NssF Employee Bal Acc";

                NHIFEMPyee := PostingGroup."NHIF Employee Account";
                NHIFEMPyeeBal := PostingGroup."NHIF Bal Acc";
    ...
    procedure GetShif(curGross: Decimal) GetShif: Decimal
    begin
        GetShif := CurGross * 0.0275;
    end;

    procedure GetHlevy(CurGross: Decimal) GetHlevy: Decimal
    begin
        GetHlevy := CurGross * 0.015;
    end;
