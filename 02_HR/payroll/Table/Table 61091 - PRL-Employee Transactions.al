table 61091 "PRL-Employee Transactions"
{
    LookupPageId = "PRL-List Transactions";
    DrillDownPageId = "PRL-List Transactions";
    fields
    {
        ...
        field(34; "Entry No"; Integer)
        {

        }
        field(35; "IsCoop/LnRep"; Boolean)
        {

        }
        field(36; EmployeePostingG; code[20])
        {

        }
        field(37; Grants; code[20])
        {

        }
        field(38; IsBasicGOK; Boolean)
        {

        }
        field(39; IsGOK; Boolean)
        {

        }
        field(40; "GOK Amount"; Decimal)
        {

        }
        field(41; "KVB Amount"; Decimal)
        {
