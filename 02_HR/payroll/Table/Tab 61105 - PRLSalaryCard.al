table 61105 "PRL-Salary Card"
{
    ...
    fields
    {
        ...
        field(30; GrossPay; Decimal)
        {
            TableRelation = "PRL-Employee P9 Info" where ("Gross Pay" = field(GrossPay));
        }
    ...
    fieldgroups
    {
        /* fieldgroup(Brick;"Employee Code","Payroll Period")
        {
        } */
    }
