page 52179130 "Stores  and Control"
{
    PageType = RoleCenter;
    layout
    {
    ...
    actions
    {
        ...
        area(reporting)
        {
            group("G/L Reports")
            {
                ...
                {
                    ApplicationArea = all;
                    RunObject = Page "Product group";
                }
                action("Item group")
                {
                    ApplicationArea = all;
                    RunObject = Page "Item Groups";
                }
            }
        ...
        area(sections)
        {
            ...
            {
                action("Detail CostCenter")
                {
                    ApplicationArea = all;
                    RunObject = report "Cost Center General2";
                    Caption = 'Cost Center Analysis (Detail)';
                }
                action("Cost Center General")
                {
                    ApplicationArea = all;
                    RunObject = report "Cost Center General (Summary)";
                    Caption = 'Cost Center General (Summary)';
                }
                ...
                action("Item cost Summary")
                {
                    ApplicationArea = all;
                    RunObject = report "Customer/Item Sales";

                }
                action("Cost Center W")
                {
                    ApplicationArea = all;
                    RunObject = report "Cost Center W (Product Group)";
                    Caption = 'Cost Center Analysis (Category)';
                }
                action("Cost Center (Product Group W)")
                {
                    ApplicationArea = all;
                    RunObject = report "Cost Center (Product Group W)";
                    Caption = 'Issue Analysis (Product Group)';
                }
                action("Supplierwise Item Rct Summary")
                {
                    ApplicationArea = all;
                    RunObject = report "Supplierwise Item Rct Summary";
                    Caption = 'Supplierwise Item Rct Summary';
                }
                action("Item Transaction History")
                {
                    ApplicationArea = all;
                    RunObject = report "Item Transaction History";
                }
                ...
                action("Items Consumption Report")
                {
                    ApplicationArea = all;
            ...
            group("Store Requisition")
            {
                ...
                action("Open Store Requisitions")
                {
                    ...
                    RunObject = page "Proc-Open Store Requisition";
                    // RunPageView = where(status = filter(<> Released));
                }
                action("Pending Stores Requisition")
                {
                    ApplicationArea = all;
                    Caption = 'Pending Stores Requisition';
                    RunObject = Page "Pending Approval StoreReqn";
                    // RunPageView = where(status = filter(<> Released));
                }
                ...
                action("Item Consumption Report")
                {
                    ApplicationArea = all;
                    RunObject = report "Item Consuption Report";
                }
