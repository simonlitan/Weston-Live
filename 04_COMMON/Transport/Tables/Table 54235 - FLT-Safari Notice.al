table 52178958 "FLT-Safari Notice"
{
        ...
        field(6; "Officer Going"; Code[20])
        {
            ...
            begin
                ...
                if hrman.Find('-') then begin
                    ...
                    "Officer Designation" := hrman."Job Title";
                    "Department Name" := hrman."Department Name";
                    safari."Emp. Pin No." := hrman."PIN Number";
                    safari.Designation := hrman."Job Title";
                end;
                usersetup.Reset;
    ...
    var
        ...
        safari: Record "FLT-Safari Accompanying Off.";
}
