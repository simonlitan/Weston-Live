page 52179048 "FLT-Transport Req."
{
    PageType = Document;
    ...
    layout
    {
        area(Content)
        {
            Group("PART ONE: APPLICANT")
            {
                ...
                field("Number of Passengers"; Rec."Number of Passangers")
                {
                    Editable = false;
                    ApplicationArea = All;
            ...
            group("PART THREE: TRANSPORT AND OPERATIONS OFFICER")
            {
                ...
                field("Transport Available/Not Av."; Rec."Transport Available/Not Av.")
                {
                    ApplicationArea = All;
            ...
            group("PART FOUR: ADMINISTRATION AND CENTRAL SERVICES")
            {
                ...
                field("Approved/Not Approved"; Rec."Approved/Not Approved")
                {
                    ApplicationArea = All;
                ...
                action("Print/Preview")
                {
                    ...
                    begin
                        ...
                        if transRe.Find('-') then
                            REPORT.Run(report::"HR Transport Allocations", true, true, transRe);
                        //RESET;
                    end;
                }
            }
