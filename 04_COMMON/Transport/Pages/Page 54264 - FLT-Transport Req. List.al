page 52179047 "FLT-Transport Req. List"
{
        ...
        area(processing)
        {
            ...
            action("Print/Preview")
            {
                ...
                begin
                    ...
                    if rec."Transport Requisition No" = '' then Error('No Record Selected.');

                    rec.Reset;
                    rec.SetRange(rec."Transport Requisition No", rec."Transport Requisition No");

                    if rec.Find('-') then
                        REPORT.Run(report::"FLT Daily Work Ticket", true, true, rec);
                end;
