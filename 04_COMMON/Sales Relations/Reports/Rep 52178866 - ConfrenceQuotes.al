report 52178866 "Confrence Quotes"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Sales Relations/Reports/SSR/ConferenceQuotation.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem(squote; "Sales Quotes")
        {
            ...
            dataitem(lines; "Sales Quote Lines")
            {
                ...
                column(Confrence_Type; "Confrence Type")
                {

                }
                column(Confrence_Description; "Confrence Description")
                {
