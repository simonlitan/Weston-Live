...
codeunit 52178865 "Webportals"
{
 ...
 procedure OnCancelLeaveApplication(leaveNo: Text) Message: Text
    ...
    procedure LeaveApplication(username: Text; reliever: Text; leaveType: Text; appliedDays: Decimal; startDate: Date; endDate: Date; returnDate: Date; purpose: Text; resCenter: Text; department: Text; offDay: Integer; totalOffDays: Decimal) Message: Text
    var
    ...
    begin
        ...
        LeaveRequisition."User ID" := FullNames;
